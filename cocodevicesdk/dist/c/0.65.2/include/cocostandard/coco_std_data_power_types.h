...
typedef enum {
  ...
  COCO_STD_ATTR_BATTERY_VOLTAGE_MV,
  COCO_STD_ATTR_BATTERY_LEVEL_PCT,
  COCO_STD_ATTR_BATT_VOLT_LOW_FLAG,
  COCO_STD_ATTR_BATT_LEVEL_LOW_FLAG,
  COCO_STD_ATTR_BATT_LEVEL_CRIT_FLAG,
