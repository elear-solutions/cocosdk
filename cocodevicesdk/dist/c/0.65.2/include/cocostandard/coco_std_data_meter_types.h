...
typedef enum {
  ...
  COCO_STD_ATTR_METER_LAST_READ_TIME_ARR,
  COCO_STD_ATTR_METER_MULTIPLIER,             // Zigbee specific attributes, To be removed
  COCO_STD_ATTR_METER_DIVISOR,                // Zigbee specific attributes, To be removed
  COCO_STD_ATTR_METER_CONS_PROD_FMT_DIGITS,   // Zigbee specific attributes, To be removed
  COCO_STD_ATTR_METER_CONS_PROD_FMT_DECIMALS, // Zigbee specific attributes, To be removed
  COCO_STD_ATTR_METER_DEMAND_FMT_DIGITS,      // Zigbee specific attributes, To be removed
  COCO_STD_ATTR_METER_DEMAND_DECIMALS,        // Zigbee specific attributes, To be removed
  COCO_STD_ATTR_METER_PRODUCTION_KWH,
  COCO_STD_ATTR_METER_UNIT_OF_MEASURE,        // Zigbee specific attributes, To be removed
