...
typedef enum {
  ...
  COCO_STD_ATTR_MOTION_DETECTED_FLAG,
  COCO_STD_ATTR_MOTION_SENSING_ENABLED,
  COCO_STD_ATTR_MOTION_IMAGE_WIDTH,
  COCO_STD_ATTR_MOTION_IMAGE_HEIGHT,
  COCO_STD_ATTR_MOTION_ROI_WIDTH,
  COCO_STD_ATTR_MOTION_ROI_HEIGHT,
  COCO_STD_ATTR_MOTION_ROI_INDICES_COUNT,
  COCO_STD_ATTR_MOTION_ROI_INDICES_ARR,
  COCO_STD_ATTR_MOTION_SENSITIVITY_PCT,
