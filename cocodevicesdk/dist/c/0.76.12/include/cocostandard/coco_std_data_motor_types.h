...
typedef enum {
  ...
  COCO_STD_ATTR_MOTOR_TILT_DOF,                  // COCO_STD_DATA_TYPE_UINT16
  COCO_STD_ATTR_MOTOR_SPEED_RPM,                 // motor speed in RPM COCO_STD_DATA_TYPE_INT16
  COCO_STD_ATTR_MOTOR_PRESET_POINT_ARR,          // array of preset points COCO_STD_DATA_TYPE_UINT8_ARR
  COCO_STD_ATTR_MOTOR_TRACK_PRESET_POINT_ARR,    // array of track preset points COCO_STD_DATA_TYPE_UINT8_ARR
  COCO_STD_ATTR_MOTOR_TRACK_ACTIVE_FLAG,         // track active flag, true if the track is active COCO_STD_DATA_TYPE_UINT8_BOOLEAN
  COCO_STD_ATTR_MOTOR_TRACK_REPEAT_COUNT,        // track repeat count COCO_STD_DATA_TYPE_INT32
  COCO_STD_ATTR_MOTOR_TRACK_DELAY_MS,            // delay in milliseconds between two preset points in track COCO_STD_DATA_TYPE_UINT32
