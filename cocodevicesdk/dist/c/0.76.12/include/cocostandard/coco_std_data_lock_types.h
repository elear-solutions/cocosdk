...
typedef enum {
  ...
  COCO_STD_ATTR_LOCK_USER_ID_ARR,     // COCO_STD_DATA_TYPE_UINT8_ARR
  COCO_STD_ATTR_LOCK_PIN_CODE_ARR,    // COCO_STD_DATA_TYPE_STRING_ARR
  COCO_STD_ATTR_LOCK_USER_STATUS_ARR, // COCO_STD_DATA_TYPE_UINT8_ARR
  COCO_STD_ATTR_LOCK_USER_TYPE_ARR,   // COCO_STD_DATA_TYPE_UINT8_ARR
