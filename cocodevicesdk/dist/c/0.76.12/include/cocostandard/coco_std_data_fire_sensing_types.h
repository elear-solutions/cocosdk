...
typedef enum {
  ...
  COCO_STD_ATTR_COOKING_IND_FLAG,           // COCO_STD_DATA_TYPE_BOOLEAN
  COCO_STD_ATTR_SMOKE_DETECTED_FLAG,        // COCO_STD_DATA_TYPE_BOOLEAN
  COCO_STD_ATTR_HEAT_DETECTED_FLAG,         // COCO_STD_DATA_TYPE_BOOLEAN
  COCO_STD_ATTR_OVERHEAT_DETECTED_FLAG,     // COCO_STD_DATA_TYPE_BOOLEAN
  COCO_STD_ATTR_COLD_DETECTED_FLAG,         // COCO_STD_DATA_TYPE_BOOLEAN
  COCO_STD_ATTR_FIRE_DETECTED_FLAG,         // COCO_STD_DATA_TYPE_BOOLEAN
