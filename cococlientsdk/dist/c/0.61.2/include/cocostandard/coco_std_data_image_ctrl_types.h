...
typedef enum {
  ...
  COCO_STD_ATTR_IMAGE_CTRL_AF_MODE_FLAG,
  COCO_STD_ATTR_IMAGE_CTRL_AE_MODE_FLAG,
  COCO_STD_ATTR_IMAGE_CTRL_AWB_MODE_FLAG,
  COCO_STD_ATTR_IMAGE_CTRL_ZOOM_TYPE,
  COCO_STD_ATTR_IMAGE_CTRL_IRCUT_MODE_TYPE,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_PRESET_TYPE,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_HUE_PCT,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_SATURATION_PCT,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_CONTRAST_PCT,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_BRIGHTNESS_PCT,
  ...
  COCO_STD_ATTR_IMAGE_CTRL_IMG_TEXT,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_TEXT_XPOSITION,
  COCO_STD_ATTR_IMAGE_CTRL_IMG_TEXT_YPOSITION,
  COCO_STD_ATTR_IMAGE_CTR_MAX,
